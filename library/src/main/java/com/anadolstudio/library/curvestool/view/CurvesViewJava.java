...
@Deprecated()
public class CurvesViewJava extends View {
    ...
    public CurvesViewJava(Context context) {
        this(context, null, 0);
    }

    public CurvesViewJava(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CurvesViewJava(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public CurvesViewJava(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
